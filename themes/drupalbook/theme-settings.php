...
function drupalbook_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id = NULL) {
  ...
  // $form['#validate'][] = 'drupalbook_settings_form_validate';
  // $form['#submit'][] = 'drupalbook_settings_form_submit';
}
// */
 ...
 */
/* -- Delete this line to enable.
function drupalbook_settings_form_validate($form, &$form_state) {
 ...
 */
 /* -- Delete this line to enable.
function drupalbook_settings_form_submit($form, &$form_state) {
